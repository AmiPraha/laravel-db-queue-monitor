...
class Monitor extends Model
{
	...
	public function __construct(array $attributes = [])
	{
		...
		$this->setTable(config('laravel-db-queue-monitor.table'));
	}
	...
	public function scopeWhereJobName($query, $jobName)
	{
		return $query->where('name', $jobName);
	}
